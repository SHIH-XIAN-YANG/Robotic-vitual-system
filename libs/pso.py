...
class PSO_Algorithm:
    def __init__(self, obj_func, nvars, population, birdstep, lower_bound, upper_bound, inertia_damp_mode=False, plot_result=False) -> None:
        ...
        self.g_learning_coef_start = 0.5        # Global learning coefficient
        self.g_learning_coef_end = 1.5
    ...
    def update(self):
        for step in range(self.birdstep):
            ...
            print(f'Iteration: {step}   fitness { self.g_fitness}   position {self.g_best}')
